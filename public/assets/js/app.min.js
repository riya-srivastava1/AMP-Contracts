var app = {
    ...
    handleScrollbar = function () {
        "use strict";
        for (
            var a = document.querySelectorAll("[" + app.scrollBar.attr + "]"),
                e = 0;
            e < a.length;
            e++
        )
        ...
        $(document).on(
                ...
                function () {
                    ...
                    $(this).is(":checked")
                        ...
                        : ($(
                              ...
                              !app.isMobile &&
                              (alert(
                                  app.themePanel.themeHeaderFixed.errorMessage
                              ),
                              $(
                                  "[" +
            ...
            $(document).on(
                ...
                function () {
                    ...
                    $(this).is(":checked")
                        ? ($("html").addClass(
                              app.themePanel.themeDarkMode.class
                          ),
    ...
    handleUnlimitedTabsRender = function () {
                            ...
                            ("rtl" != $("body").css("direction")
                                ? $(s)
                                      ...
                                      .animate(
                                          ...
                                          function () {
                                              $(s).addClass(
                                                  app.unlimitedTabs.overflowLeft
                                                      .class
                                              );
                                          }
                                      )
                        ...
                        "rtl" != $("body").css("direction")
                            ? $(s)
                                  ...
                                  .animate(
                                      ...
                                      function () {
                                          $(s).addClass(
                                              app.unlimitedTabs.overflowRight
                                                  .class
                                          );
                                      }
                                  )
        ...
        $("[" + app.unlimitedTabs.buttonNext.toggleAttr + "]").click(function (
            e
        ) {
            e.preventDefault(), a(this, "next");
        }),
            $("[" + app.unlimitedTabs.buttonPrev.toggleAttr + "]").click(
                function (e) {
    ...
    handleUnlimitedTopMenuRender = function () {
                                      ...
                                      $(s)
                                          .find(
                                              "." +
                                                  app.topMenu.control.class +
                                                  "." +
                                                  app.topMenu.control.buttonNext
                                                      .class
                                          )
                                          .addClass("show");
                                  }
        ...
        $("[" + app.topMenu.control.buttonNext.toggleAttr + "]").click(
            function (e) {
                e.preventDefault(), a(this, "next");
            }
        ),
            $("[" + app.topMenu.control.buttonPrev.toggleAttr + "]").click(
                function (e) {
                    e.preventDefault(), a(this, "prev");
                }
            ),
                            ...
                            if (e) {
                                ...
                                if (
                                    ...
                                    l > r &&
                                        ...
                                        (e =
                                            '<div class="' +
                                            app.sidebar.floatSubmenu.container
                                                .class +
                                            '" id="' +
                                            ...
                                            app.sidebar.floatSubmenu.arrow
                                                .class +
                                            '" id="' +
            ...
            Pace.restart(),
                ...
                (function (a) {
                    ...
                    0 !== $(e).length &&
                        ...
                        ).removeClass(app.sidebar.menu.activeClass),
                        $(e)
                            .closest("." + app.sidebar.menu.itemClass)
    ...
    handleClearPageOption = function (a) {
        a.appContentFullHeight &&
            ...
            a.appContentClass &&
                $(app.content.id).removeClass(a.appContentClass),
    ...
    handleToggleNavbarSearch = function () {
        $("[" + app.header.floatingForm.toggleAttr + "]").click(function (a) {
            ...
            $("[" + app.header.floatingForm.dismissAttr + "]").click(function (
                a
            ) {
                a.preventDefault(),
                    $("." + app.header.class).removeClass(
    ...
    handleAnimation = function () {
        $("[" + app.animation.attr + "]").each(function () {
            ...
            switch (a) {
                ...
                case "number":
                    for (
                        var s = this, t = countDecimals(e), p = 1, l = t;
                        l > 0;
                    ...
                    $({ animateNumber: 0 }).animate(
                        { animateNumber: e },
                        {
                            ...
                            step: function () {
                                var a = (
                                    Math.ceil(this.animateNumber * p) / p
                                ).toFixed(t);
        ...
        return {
            ...
            initVariable: function () {
                (app.color.theme = getCssVariable("--app-theme")),
                    ...
                    (app.color.componentColor = getCssVariable(
                        "--app-component-color"
                    )),
                    (app.color.componentBg =
                        getCssVariable("--app-component-bg")),
                    ...
                    (app.font.familyRgb = getCssVariable(
                        "--bs-body-font-family-rgb"
                    )),
                    (app.font.sizeRgb = getCssVariable(
                        "--bs-body-font-size-rgb"
                    )),
                    (app.font.weightRgb = getCssVariable(
                        "--bs-body-font-weight-rgb"
                    )),
                    (app.color.componentColorRgb = getCssVariable(
                        "--app-component-color-rgb"
                    )),
                    (app.color.componentBgRgb = getCssVariable(
                        "--app-component-bg-rgb"
                    )),
                    ...
                    (app.color.gray100Rgb =
                        getCssVariable("--bs-gray-100-rgb")),
                    (app.color.gray200Rgb =
                        getCssVariable("--bs-gray-200-rgb")),
                    (app.color.gray300Rgb =
                        getCssVariable("--bs-gray-300-rgb")),
                    (app.color.gray400Rgb =
                        getCssVariable("--bs-gray-400-rgb")),
                    (app.color.gray500Rgb =
                        getCssVariable("--bs-gray-500-rgb")),
                    (app.color.gray600Rgb =
                        getCssVariable("--bs-gray-600-rgb")),
                    (app.color.gray700Rgb =
                        getCssVariable("--bs-gray-700-rgb")),
                    (app.color.gray800Rgb =
                        getCssVariable("--bs-gray-800-rgb")),
                    (app.color.gray900Rgb =
                        getCssVariable("--bs-gray-900-rgb")),
