<x-app-layout>
    ...
    <div id="content" class="app-content">
        ...
        <!-- END breadcrumb -->
        <!-- BEGIN page-header -->
        <h1 class="page-header">Banner Image Trash Data....</h1>
        <!-- END page-header -->
        <!-- BEGIN row -->
        <!-- BEGIN panel -->
                        ...
                        <tbody>
                            @foreach ($bannerImages as $bannerImage)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <form action="{{ route('restore.bannerimage', $bannerImage['id']) }}"
                                                method="post">
                                            ...
                                            <form action="{{ route('delete.bannerimage', $bannerImage['id']) }}"
                                                method="post">
