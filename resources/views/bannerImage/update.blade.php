<x-app-layout>
    ...
    <div id="content" class="app-content">
        ...
        <!-- END breadcrumb -->
        <!-- BEGIN page-header -->
        <h1 class="page-header">Update Banner Image.....</h1>
        <!-- END page-header -->
            ...
            <div class="col-xl-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{ route('bannerimage.update', $bannerImage->id) }}"
                            ...
                            <div class="row mb-15px">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="is_active">
                                        <option value="1" {{ $bannerImage->is_active == '1' ? 'selected' : '' }}>
                                            Active</option>
                                        <option value="0" {{ $bannerImage->is_active == '0' ? 'selected' : '' }}>
                                            Inactive</option>
                                    </select>
                                </div>
                            </div>
