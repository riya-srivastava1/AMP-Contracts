<x-app-layout>
    ...
    <div id="content" class="app-content">
        ...
        <ol class="breadcrumb float-xl-end">
            ...
            <li class="breadcrumb-item active">upadet</li>
        </ol>
        <!-- END breadcrumb -->
        <!-- BEGIN page-header -->
        <h1 class="page-header">Upadte WebSite Infos.....</h1>
        <!-- END page-header -->
            ...
            <div class="col-xl-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{ route('website.update', $webinfo->id) }}"
                            ...
                            <div class="row mb-15px">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="title" class="form-control mb-5px"
                                        placeholder="Enter title" value="{{ $webinfo->title }}" />
                                </div>
                            </div>
                            <div class="row mb-15px">
                            ...
                            <div class="row mb-15px">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" name="meta_description" rows="3">{{ $webinfo->meta_description }}</textarea>
                                </div>
                            </div>
